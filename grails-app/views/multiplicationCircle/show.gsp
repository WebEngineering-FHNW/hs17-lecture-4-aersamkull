...
<body>
	<form action="/multiplicationCircle/index">
		<tmpl:up_down_input name="segmentCount" label="Segments"
			value="${circleInstance.segmentCount}" />
		<tmpl:up_down_input name="tableBase" label="Table Base"
			value="${circleInstance.tableBase}" />
	</form>
